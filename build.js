    ...
    content: `
      ...
      <section class="w-full">
        <div class="w-full h-[400px] md:h-[500px] bg-gray-200 dark:bg-gray-800 relative">
          <!-- Placeholder map -->
          <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" src="https://maps.google.com/maps?q=New%20York&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </section>
    ...
    content: `
      <div class="flex h-screen bg-gray-50 dark:bg-gray-950 overflow-hidden w-full">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
          ...
          <main class="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 lg:p-8 scroll-smooth w-full">
                      ...
                      <table class="w-full text-left text-sm whitespace-nowrap">
                        <thead class="bg-gray-50 dark:bg-gray-800/30 text-gray-500 uppercase text-xs font-bold border-b border-gray-200 dark:border-gray-800">
                          <tr>
                            ...
                            <th class="px-3 sm:px-6 py-3">Last Updated</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-3 sm:px-6 py-4 text-gray-500">2 days ago</td>
                          ...
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-3 sm:px-6 py-4 text-gray-500">1 month ago</td>
                            <td class="px-3 sm:px-6 py-4 text-right">
                              <button class="text-indigo-600 dark:text-indigo-400 hover:underline">Edit</button>
                            </td>
                          </tr>
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-3 sm:px-6 py-4 text-gray-500">1 week ago</td>
                            <td class="px-3 sm:px-6 py-4 text-right">
                              <button class="text-indigo-600 dark:text-indigo-400 hover:underline">Edit</button>
                            </td>
                          </tr>
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-3 sm:px-6 py-4 text-gray-500">2 months ago</td>
                            <td class="px-3 sm:px-6 py-4 text-right">
                              <button class="text-indigo-600 dark:text-indigo-400 hover:underline">Edit</button>
                            </td>
                          </tr>
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-3 sm:px-6 py-4"><span class="px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-xs text-gray-600 dark:text-gray-300">Financial</span></td>
                            <td class="px-3 sm:px-6 py-4 text-gray-500">3 days ago</td>
                            <td class="px-3 sm:px-6 py-4 text-right">
                              <button class="text-indigo-600 dark:text-indigo-400 hover:underline">Edit</button>
                            </td>
                          </tr>
                    ...
                    <div class="p-6">
                      <ul class="space-y-4 relative before:absolute before:inset-y-0 before:left-2.5 before:w-px before:bg-gray-200 dark:before:bg-gray-800 pl-8">
                        <li class="relative">
                          ...
                          <p class="text-xs text-gray-500 break-words pr-2">Today, 10:02 AM • New York, US</p>
                        </li>
                        <li class="relative">
                          ...
                          <p class="text-xs text-gray-500 break-words pr-2">Yesterday, 4:30 PM</p>
                        </li>
                        <li class="relative">
                          ...
                          <p class="text-xs text-gray-500 break-words pr-2">Sept 24, 2:15 PM • Sarah Jenkins accessed Last Will</p>
                        </li>
                        <li class="relative">
                          ...
                          <p class="text-xs text-gray-500 break-words pr-2">Sept 24, 9:00 AM • 2FA enabled</p>
                        </li>
                        <li class="relative">
                          ...
                          <p class="text-xs text-gray-500 break-words pr-2">Sept 23, 11:15 AM</p>
                        </li>
                      </ul>
